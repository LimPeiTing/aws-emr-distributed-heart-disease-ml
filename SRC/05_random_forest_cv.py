...
# HEART DISEASE — RANDOM FOREST WITH 10-FOLD CV (SPARK)


# 1. Initialize Spark Session
spark = SparkSession.builder \
    .appName("HeartDiseaseRF_CV") \
    .getOrCreate()
...
# 7. Configure Random Forest Classifier
...
print("\n" + "=" * 50)
print("STARTING 10-FOLD CV (Random Forest)")
print("=" * 50)

# Split dataset into 10 roughly equal folds
...
output_path = "s3://heart-disease-ga2-gold/models/final_model_rf"
