...
# HEART DISEASE — GBT WITH 10-FOLD CV (SPARK)


# 1. Initialize Spark Session
spark = SparkSession.builder \
    .appName("HeartDiseaseGBT_CV") \
    .getOrCreate()
...
# 7. Configure Gradient Boosted Tree Classifier
print("... CONFIGURING GRADIENT BOOSTED TREE ...")
...
print("\n" + "=" * 50)
print("STARTING 10-FOLD CV (Gradient Boosted Tree)")
print("=" * 50)
...
print("\n" + "=" * 50)
print("  GRADIENT BOOSTED TREE 10-FOLD RESULTS")
print("=" * 50)
...
print("\n... Saving Final Gradient Boosted Tree Model ...")

final_model = pipeline.fit(df)

output_path = "s3://heart-disease-ga2-gold/models/final_model_gbt"
